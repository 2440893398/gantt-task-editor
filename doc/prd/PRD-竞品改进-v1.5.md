...
- **定位**：在 v1.0 建立核心调度能力与稳定性的基础上，引入**专业级决策辅助**功能。
- **目标用户**：高级项目经理 (需要基线和高级报表)。
- **核心价值**：从 "可用" 升级为 "专业"。
...
### 3.3 资源管理 (Resource Management v0.5) - P2 (探索性)
- **目标**：初步识别资源分配情况。
- **功能要求**：
