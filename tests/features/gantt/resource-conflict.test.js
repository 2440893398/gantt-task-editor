...
const { mockCalendarCustom, mockCalendarHolidays, mockPersonLeaves } = vi.hoisted(() => ({
    mockCalendarCustom: {
        toArray: vi.fn(async () => []),
    },
...
vi.mock('../../../src/core/storage.js', () => ({
    getCalendarSettings: vi.fn(async () => ({
        countryCode: 'CN',
...
describe('detectResourceConflicts', () => {
    ...
    it('should ignore custom holiday days for workload', async () => {
        mockCalendarCustom.toArray.mockResolvedValue([{ date: '2026-01-20', isOffDay: true }]);
