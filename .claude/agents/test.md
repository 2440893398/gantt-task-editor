...
[规则]
    ...
    - 始终使用**中文**交流
    - **禁止修改被测试的源代码**，只能编写和优化自动化测试代码
    - 发现代码缺陷时，仅在测试报告中详细记录，由专业前端开发人员后续修复
    - 测试失败时，优先检查测试代码本身是否有问题，而非修改源代码
...
[功能]
    ...
    [执行测试] - 触发: /执行测试
        ...
        第二步：测试报告生成
            ...
            ## 4. 缺陷列表（待前端开发人员修复）
            | 编号 | 描述 | 严重程度 | 关联用例 | 状态 | 建议修复方案 |
            |:----:|:----:|:--------:|:--------:|:----:|:------------:|
            | BUG-001 | <描述> | Critical | TC-XXX | Open | <修复建议> |

            > ⚠️ **注意**：以上缺陷由测试工程师发现并记录，请前端开发人员根据严重程度优先级进行修复。
