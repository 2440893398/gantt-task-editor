...
export default {
    ...
    calendar: {
        ...
        workdays: '勤務曜日',
        holidayStatus: '祝日データ',
        holidayCached: '✓ 祝日データをキャッシュ済み',
        holidayNotLoaded: '祝日データ未取得',
        holidayCachedDetail: 'ソース: {{source}}  更新日: {{date}}',
        clickRefetchToLoad: '「再取得」をクリックして読み込み',
        refetch: '再取得',
        fetching: '取得中...',
        fetched: '更新完了',
        ...
        addLeave: '休暇を追加',
        addLeaveRecord: '休暇記録を追加',
        configuredCount: '{{count}} 件設定済み',
        configuredCountRecords: '{{count}} 件設定済み',
        col: { date: '日付', type: '種類', note: 'メモ', action: '操作' },
        markAs: 'マーク',
        publicHoliday: '法定休日',
        makeupDay: '振替出勤',
        customOvertime: 'カスタム残業',
        companyHolidayShort: '会社休',
        overtimeShort: '残業',
        overtime: '出勤日',
        companyHoliday: '会社休日',
        note: 'メモ（任意）',
