...
export default {
    ...
    calendar: {
        ...
        workdays: '工作日设置',
        holidayStatus: '节假日数据',
        holidayCached: '✓ 节假日已缓存',
        holidayNotLoaded: '节假日未加载',
        holidayCachedDetail: '来源: {{source}}  更新: {{date}}',
        clickRefetchToLoad: '点击「重新拉取」加载',
        refetch: '重新拉取',
        fetching: '拉取中...',
        fetched: '已更新',
        calendarView: '日历视图',
        ...
        configuredCountRecords: '已配置 {{count}} 条',
        col: { date: '日期', type: '类型', note: '备注', action: '操作' },
        markAs: '标记为',
        publicHoliday: '法定假',
        makeupDay: '补班',
        customOvertime: '自定义加班',
        companyHolidayShort: '公司假',
        overtimeShort: '加班',
        overtime: '加班日',
        companyHoliday: '公司假期',
        note: '备注（可选）',
