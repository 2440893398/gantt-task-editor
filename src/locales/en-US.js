...
export default {
    ...
    share: {
        ...
        keyHint: 'Enter a previous key to update the legacy snapshot.',
        initialHint: 'Generate a share link and copy it to others.',
        generate: 'Generate Snapshot Link',
        ...
        uploadFailed: 'Upload failed. Check your network or use file export.',
        notFound: 'Share link expired or was not found. Ask the sharer to send it again.',
        forbidden: 'Share link has no permission or is no longer valid',
        loadFailed: 'Failed to load share data',
        importTitle: 'Share Link Detected',
        importViewSubtitle: "You will import a local copy. The sharer's data will not be changed.",
        importEditSubtitle:
            'Import as a local project, or bind it so future edits update the cloud copy.',
        taskCount: 'Tasks',
        exportedAt: 'Shared at',
        importMode: 'Choose import mode',
        importNew: 'Import as New Project (Recommended)',
        importNewHint: 'Create a local project without changing existing data.',
        importBindEdit: 'Import and Bind Online Editing',
        importBindEditHint: 'Future local edits will update this cloud copy automatically.',
        importReplace: 'Replace Current Project',
        importReplaceHint: 'Replace the current project data. This cannot be undone.',
        ...
        permissionEdit: 'Online editing',
        cloudCopy: 'Cloud Copy',
        cloudSubtitle: 'For ongoing sharing and online editing',
        cloudHint:
            'After creating a cloud copy, editor changes update the online copy and viewers open the latest data.',
        cloudStepCreate: 'Create a cloud copy',
        cloudStepShare: 'Copy view or edit links',
        cloudStepSync: 'Local edits update the online copy',
        cloudStatusNotCreated: 'Not created',
        cloudStatusNotCreatedHint: 'Create one to generate view and edit links.',
        cloudStatusSynced: 'Synced',
        cloudStatusSyncedHint:
            'Viewers opening the link will read the latest version of this cloud copy.',
        cloudStatusSyncing: 'Syncing',
        cloudStatusSyncingHint: 'Updating the cloud copy with the latest local changes.',
        cloudStatusError: 'Sync failed',
        cloudStatusErrorHint: 'Check your network and try again.',
        cloudStatusConflict: 'Conflict',
        cloudVersionEmpty: 'No version yet',
        cloudEnabled: 'Cloud copy enabled',
        version: 'Version',
        syncStatus: 'Sync status',
        lastSyncedAt: 'Last synced',
        cloudConflict: 'The cloud version has changed. Pull the latest data or create a new copy.',
        cloudConflictShort: 'Cloud version changed. Resolve the conflict.',
        viewLink: 'View link',
        viewLinkHint: 'Read-only access. Opens the latest data.',
        editLink: 'Edit link',
        editLinkHint: 'Can bind for editing; future local edits sync to the cloud copy.',
        syncNow: 'Sync Now',
        unbindCloud: 'Unbind',
        refreshCloudLinks: 'Refresh Cloud Links',
        createCloudCopy: 'Create Cloud Copy',
        cloudCreated: 'Cloud copy created',
        cloudSynced: 'Cloud copy synced',
        cloudUnbound: 'Cloud binding removed',
        cloudBound: 'Bound to cloud copy. Future edits will sync automatically.',
        readOnlyBadge: 'Read only',
        readOnlyProject: 'Shared Project',
        readOnlyHint:
            'You are viewing a read-only cloud link. Editing is disabled; refresh to get the latest version.',
        refreshReadOnly: 'Refresh Latest Data',
        refreshingReadOnly: 'Refreshing...',
        readOnlyRefreshed: 'Latest data loaded',
        legacySnapshot: 'One-time Snapshot Link',
        legacySnapshotHint: 'Sends a static copy. Future edits are not synced.',
    },
    ...
    feedback: {
        ...
        type: 'Type',
        typeBug: 'Bug',
        typeImprovement: 'Optimization',
        typeRequirement: 'Requirement',
        typeOther: 'Other',
        typeUnclear: 'Not sure',
