...
export default {
    ...
    calendar: {
        ...
        holidayCached: '✓ 공휴일 데이터 캐시됨',
        holidayNotLoaded: '공휴일 데이터가 로드되지 않음',
        holidayCachedDetail: '출처: {{source}}  업데이트: {{date}}',
        clickRefetchToLoad: '다시 불러오기를 눌러 로드',
        refetch: '다시 불러오기',
        fetching: '불러오는 중...',
        fetched: '업데이트 완료',
        calendarView: '달력 보기',
        ...
        addLeave: '휴가 추가',
        addLeaveRecord: '휴가 기록 추가',
        configuredCount: '{{count}}개 설정됨',
        configuredCountRecords: '{{count}}건 설정됨',
        col: { date: '날짜', type: '유형', note: '메모', action: '작업' },
        markAs: '표시',
        publicHoliday: '법정 휴일',
        makeupDay: '대체 근무일',
        customOvertime: '사용자 정의 초과근무',
        companyHolidayShort: '회사휴일',
        overtimeShort: '초과근무',
        overtime: '근무일',
