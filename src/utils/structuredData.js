...
export function injectStructuredData() {
    const schema = {
        ...
        description:
            'Free online Gantt chart project management tool with AI assistant, multi-language support, Excel import/export, critical path analysis, and resource conflict detection.',
