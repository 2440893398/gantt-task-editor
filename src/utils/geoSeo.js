...
const META_CONFIG = {
    'zh-CN': {
        ...
        description:
            '免费在线甘特图项目管理工具，支持 AI 智能助手、Excel 导入导出、多语言、关键路径分析、资源冲突检测。适合项目经理和团队使用。',
        ogTitle: '甘特图项目管理工具',
    ...
    'en-US': {
        ...
        description:
            'Free online Gantt chart project management tool with AI assistant, Excel import/export, critical path analysis, resource conflict detection, and multi-language support.',
        ogTitle: 'Gantt Chart Project Manager',
        ogDescription:
            'Free online Gantt chart with AI assistant, Excel support, and critical path analysis.',
    },
    'ja-JP': {
        title: 'ガントチャートプロジェクト管理 - 無料オンラインツール',
        description:
            '無料オンラインガントチャートプロジェクト管理ツール。AIアシスタント、Excel入出力、クリティカルパス分析、リソース競合検出、多言語対応。',
    ...
    'ko-KR': {
        ...
        description:
            '무료 온라인 간트차트 프로젝트 관리 도구. AI 어시스턴트, Excel 가져오기/내보내기, 크리티컬 패스 분석, 리소스 충돌 감지, 다국어 지원.',
